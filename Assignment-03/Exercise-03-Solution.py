#  What I used: 1.Object-oriented programming   2.Showing Score
# Zahra Jiriaei
# Import library
from tkinter import *
import random
...
class Ball:
    def __init__(self, canvas, color, size, paddle):
        ...
        All the ball properties and functions defined
        """
        self.canvas = canvas
        self.paddle = paddle
    ...
    def hit_paddle(self, pos):
        """
        Define what will happen if ball hit the paddle
        """
...
class Paddle:
    def __init__(self, canvas, color):
        ...
        Args:
            canvas (_type_): _description_
            color (_type_): _description_
        All the paddle properties and functions defined
        """
        self.canvas = canvas
...
# Create window 
canvas = Canvas(root, width=500, height=400, bg='papaya whip')
canvas.pack()
# Create score counter on window
...
go_label = canvas.create_text(150,100,text="GAME OVER",font=("black",20))
root.update()
